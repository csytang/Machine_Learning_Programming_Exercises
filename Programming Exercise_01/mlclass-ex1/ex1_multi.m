...
X = data(:, 1:2); % X is a m by2 matrix with m for the number of training examples.
y = data(:, 3); % y is a m by 1 vector with m for the number of training examples
m = length(y);
